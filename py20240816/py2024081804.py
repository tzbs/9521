...
cups = soup.select('div.publish_content.publish_record_history div.weui-desktop-block')

# 遍历找到的元素
for cup in cups:
	# 处理每个元素，例如打印其内容
	print(cup.get_text(strip=True))
#cup1=soup.findAll('div',attrs={'class':'publish_content publish_record_history'})
#cup2=cup1.findAll('div',attrs={'class':'weui-desktop-block'})
#print(cup2)
